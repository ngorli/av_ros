...
"""autogenerated by genpy from gps_navigation/WaypointActionResult.msg. Do not edit."""
import sys
...
class WaypointActionResult(genpy.Message):
  ...
  _type = "gps_navigation/WaypointActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gps_navigation/WaypointResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gps_navigation.msg.WaypointResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gps_navigation.msg.WaypointResult()
