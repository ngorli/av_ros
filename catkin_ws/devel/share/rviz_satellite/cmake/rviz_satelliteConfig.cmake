...
if("TRUE" STREQUAL "TRUE")
  set(rviz_satellite_SOURCE_PREFIX /home/user/catkin_ws/src/src/rviz_satellite)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_satellite' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/src/rviz_satellite/${idir}'.  ${_report}")
    endif()
